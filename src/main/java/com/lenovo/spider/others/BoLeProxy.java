...
public class BoLeProxy implements PageProcessor {


    //public static final String URL_LIST = "https://www.douban.com/doulist/\\d+\\";
    public static final String URL_POST = "http://blog.jobbole.com/\\d+\\/?utm_source=blog.jobbole.com&utm_medium=relatedPosts";

    private Site site = Site
            .me()
            .setDomain("blog.jobbole.com")
            .setUseGzip(true)
    ...
    public void process(Page page) {
        ...
        if (selectUrl.regex(URL_POST).match()) {
                page.putField("", page.getHtml().xpath("//div[@id='bd']//div[@class='atl-main']/tidyText()"));
            }
        }
    ...
    public static void main(String[] args) {
        ...
        Spider spider = Spider.create(new BoLeProxy())
                .addUrl("http://blog.jobbole.com/114397/?utm_source=blog.jobbole.com&utm_medium=relatedPosts")
