...
public class TianYaProxy implements PageProcessor {

    //public static final String URL_LIST = "https://www.douban.com/doulist/\\d+\\";
    public static final String URL_POST = "http://bbs.tianya.cn/\\.*.shtml";

    private Site site = Site
            .me()
            .setDomain("bbs.tianya.cn")
            .setUseGzip(true)
    ...
    public static void main(String[] args) {
        ...
        Spider spider = Spider.create(new TianYaProxy())
